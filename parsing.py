...
sheet_path = "files\\AprilSheet.xlsx"
...
fnma_fhlmc_schema_validator ={
    "$jsonSchema": {
        ...
        "properties": {
            ...
            "productFeature":{
            "enum": ["PURCHASE_FIXED","UNITS_2","UNITS_3_2" ,"INVESTMENT_PROPERTY" , "HOME_SECOND" ,"CONDO_ATTACHED_TERM_15_ABOVE" ,"ARM" ,"HIGHBAL_TERM_15_ABOVE","HIGHBAL_CASHOUT_YES" , "ARM_HIGHBAL" ,"TEMP_BUYDOWN" ],
            "description": "must be string and is required"
            },
            "llpas":{
                "bsonType": "array",
...
"$jsonSchema": {
    ...
    "properties":{
        ...
        "productFeature": {
            "enum":["PURCHASE_FIXED","UNITS_2","UNITS_3_2","INVESTMENT_PROPERTY","HOME_SECOND","CONDO_ATTACHED_TERM_15_ABOVE","ARM",
